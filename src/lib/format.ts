...
/**
 * The table's form: one letter of unit and no trailing zeros, so a column holds
 * "4.91K | 626B" in the width `bytes` spends on one side.
 */
...
/** Whole days once past one, a running clock below it. */
